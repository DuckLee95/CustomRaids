...
![玩家共同抵御尸潮](images/example1.png)

> 该图为某公益服的插件测试画面，30 多名玩家在线共同抵御 20 波尸潮，**性能优化极好**。

![CustomRaids 管理菜单](images/example2.png)
...
[购买 CustomRaids](https://ifdian.net/a/yyyork)
...
请通过 [GitHub Issues](https://github.com/DuckLee95/CustomRaids/issues) 反馈 Bug。提交时请附上服务端类型、Minecraft 版本、插件版本、相关日志和问题复现步骤。
